...
HTTP_400_BAD_REQUEST = {
    ...
    400003: _("User candidates does not exist"),
    400004: _("Language level does not exist"),
    400005: _("Technical does not exist"),
    400006: _("Technical level does not exist"),
    400007: _("Project does not exist."),
    400008: _("Role does not exist."),
    400009: _("User Experience does not exist."),
    400010: _("Process does not exist."),
    400011: _("User university does not exist"),
    400014: _("User candidates id existed"),
    400015: _("User Experience existed."),
    400016: _("Project Role already existed"),
    400017: _("Project Technical already existed"),
    400018: _("Project Process already existed"),
    400019: _("Please choices other status"),
...
HTTP_401_UNAUTHORIZED = {
    ...
    401004: _("Unknown or invalid refresh token."),
    401005: _("You have already registered for this account, please try another account."),
}
