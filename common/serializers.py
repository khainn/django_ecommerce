...
class MultipleLanguageJSON(serializers.Serializer):
    EN = serializers.CharField(max_length=1000, allow_blank=True)
    JP = serializers.CharField(max_length=1000, allow_blank=True)
    ...
    def validate(self, attrs):
        ...
        if not en and not jp:
            raise serializers.ValidationError(detail={
                'field': "Bold EN and JP are empty"
            })
        return attrs
